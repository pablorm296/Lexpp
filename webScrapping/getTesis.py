...
tesisConfig = LexppConfig(logFile = "./logs/tesis_{0}.log".format(todayDate), logLevel = logging.INFO, targetClient = 'mongodb://localhost:27017', targetDB = "tesisSCJN", targetCollection = "tesis")
